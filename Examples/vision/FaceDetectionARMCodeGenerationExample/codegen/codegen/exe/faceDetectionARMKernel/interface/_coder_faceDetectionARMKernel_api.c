 ...
 * File: _coder_faceDetectionARMKernel_api.c
 *
...
emlrtContext emlrtContextGlobal = { true,/* bFirstTime */
  ...
  NULL,                                /* fErrorFunction */
  "faceDetectionARMKernel",            /* fFunctionName */
  NULL,                                /* fRTCallStack */
  false,                               /* bDebugMode */
...
static uint8_T (*emlrt_marshallIn(const emlrtStack *sp, const mxArray *inRGB,
  ...
  const char_T *identifier))[921600]
{
  ...
  y = b_emlrt_marshallIn(sp, emlrtAlias(inRGB), &thisId);
  emlrtDestroyArray(&inRGB);
  return y;
}
/*
 ...
 * Return Type  : void
 */
void faceDetectionARMKernel_api(const mxArray * const prhs[1], int32_T nlhs,
  const mxArray *plhs[1])
{
  uint8_T (*outRGB)[921600];
  uint8_T (*inRGB)[921600];
  ...
  outRGB = (uint8_T (*)[921600])mxMalloc(sizeof(uint8_T [921600]));

  /* Marshall function inputs */
  inRGB = emlrt_marshallIn(&st, emlrtAlias(prhs[0]), "inRGB");

  /* Invoke the target function */
  faceDetectionARMKernel(*inRGB, *outRGB);

  /* Marshall function outputs */
  plhs[0] = emlrt_marshallOut(*outRGB);
}
 ...
 * Return Type  : void
 */
void faceDetectionARMKernel_atexit(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
  ...
  faceDetectionARMKernel_xil_terminate();
}
 ...
 * Return Type  : void
 */
void faceDetectionARMKernel_terminate(void)
{
  emlrtStack st = { NULL,              /* site */
    NULL,                              /* tls */
    NULL                               /* prev */
...
/*
 * File trailer for _coder_faceDetectionARMKernel_api.c
 *
 * [EOF]
 */
