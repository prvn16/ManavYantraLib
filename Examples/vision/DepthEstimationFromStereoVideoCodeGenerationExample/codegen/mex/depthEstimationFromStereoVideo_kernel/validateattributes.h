...
extern void b_validateattributes(const emlrtStack *sp, const emxArray_real32_T
  *a);
extern void validateattributes(const emlrtStack *sp, const emxArray_real32_T *a);
