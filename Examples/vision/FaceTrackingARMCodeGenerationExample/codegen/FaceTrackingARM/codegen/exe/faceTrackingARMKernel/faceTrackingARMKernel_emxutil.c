 ...
 * File: faceTrackingARMKernel_emxutil.c
 *
...
static void emxFreeStruct_cell_wrap_62(cell_wrap_62 *pStruct);
static void emxInitStruct_cell_wrap_62(cell_wrap_62 *pStruct);

/* Function Definitions */

/*
 * Arguments    : cell_wrap_62 *pStruct
 * Return Type  : void
 */
static void emxFreeStruct_cell_wrap_62(cell_wrap_62 *pStruct)
{
...
/*
 * Arguments    : vision_internal_cornerPoints_cg *pStruct
 * Return Type  : void
 */
void c_emxFreeStruct_vision_internal(vision_internal_cornerPoints_cg *pStruct)
{
 ...
 * Return Type  : void
 */
void c_emxInitStruct_vision_internal(vision_internal_cornerPoints_cg *pStruct)
{
  emxInit_real32_T(&pStruct->pLocation, 2);
  emxInit_real32_T1(&pStruct->pMetric, 1);
}
 ...
 * Return Type  : void
 */
void emxEnsureCapacity_real32_T2(emxArray_real32_T *emxArray, int oldNumel)
{
  int newNumel;
  int i;
  void *newData;
...
/*
 * Arguments    : cell_wrap_62 pMatrix[2]
 * Return Type  : void
 */
void emxFreeMatrix_cell_wrap_62(cell_wrap_62 pMatrix[2])
{
  int i;
  for (i = 0; i < 2; i++) {
    emxFreeStruct_cell_wrap_62(&pMatrix[i]);
  }
}
 ...
 * Return Type  : void
 */
void emxInitMatrix_cell_wrap_62(cell_wrap_62 pMatrix[2])
{
  int i;
  for (i = 0; i < 2; i++) {
    emxInitStruct_cell_wrap_62(&pMatrix[i]);
  }
}
 ...
 * Return Type  : void
 */
void emxInit_real32_T2(emxArray_real32_T **pEmxArray, int numDimensions)
{
  emxArray_real32_T *emxArray;
  int i;
  *pEmxArray = (emxArray_real32_T *)malloc(sizeof(emxArray_real32_T));
...
/*
 * File trailer for faceTrackingARMKernel_emxutil.c
 *
 * [EOF]
 */
