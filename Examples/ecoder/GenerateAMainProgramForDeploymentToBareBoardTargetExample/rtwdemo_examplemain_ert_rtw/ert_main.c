 ...
 * C/C++ source code generated on : Thu Jan 25 09:39:40 2018
 *
...
#include "rtwdemo_examplemain.h"       /* Model's header file */
#include "rtwtypes.h"
...
int_T main(int_T argc, const char *argv[])
{
  ...
  /* Initialize model */
  rtwdemo_examplemain_initialize();
